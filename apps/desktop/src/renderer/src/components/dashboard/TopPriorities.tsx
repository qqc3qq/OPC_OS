...
import { Card, CardHeader, CardTitle, CardContent, Button, PriorityBadge, StatusBadge } from '@ceo-os/ui'
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <Button variant="ghost" size="sm" className="text-xs text-zinc-400 gap-1">
